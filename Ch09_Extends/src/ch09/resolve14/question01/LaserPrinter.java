...
public class LaserPrinter extends Printer {
	...
	public LaserPrinter(String modelName, String manufacturer, P_INTERFACE pInterface, int printCount, int paperRemain, double tonnerRemainders) {
	...
	public String toString() {
		return "LaserPrint [tonnerRemainders=" + tonnerRemainders + ", modelName=" + modelName + ", manufacturer="
